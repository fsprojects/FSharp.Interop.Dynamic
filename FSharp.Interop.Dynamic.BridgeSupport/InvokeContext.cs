...
// commit 38fcb82, Dynamitey/InvokeContext.cs). Trimmed to what FSharp.Interop.Dynamic calls; see
...
namespace FSharp.Interop.Dynamic.BridgeSupport
{
    ...
    {
        /// <summary>
        /// Performs an explicit conversion from <see cref="System.Type"/> to <see cref="StaticContext"/>.
        /// </summary>
