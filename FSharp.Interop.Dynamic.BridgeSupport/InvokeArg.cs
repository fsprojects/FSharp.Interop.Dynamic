...
// commit 38fcb82, Dynamitey/InvokeArg.cs). Trimmed to what FSharp.Interop.Dynamic calls; see
// THIRD-PARTY-NOTICES.txt. Dropped: InvokeArg<T>.
...
namespace FSharp.Interop.Dynamic.BridgeSupport
{
    ...
    public class InvokeArg
    {
        ...
        /// </summary>
        public static readonly Func<string, object, InvokeArg> Create = (n, v) => new InvokeArg(n, v);
